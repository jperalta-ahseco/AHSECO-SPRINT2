...
namespace NPOI.Extension
{
    ...
    public static class IEnumerableNpoiExtensions
    {
        ...
        public static IWorkbook ToWorkBook<T>(this IEnumerable<T> source, string sheetName = "sheet0", ICellStyle titleStyle = null, ICellStyle cellStyle = null)
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
            ...
            return source.ToWorkbook(null, sheetName, titleStyle, cellStyle);

        }

        internal static IWorkbook ToWorkbook<T>(this IEnumerable<T> source, string excelFile, string sheetName, ICellStyle titleStyle=null, ICellStyle cellStyle=null)
        {
            ...
            foreach (var item in source)
            {
                ...
                for (var i = 0; i < properties.Length; i++)
                {
                    ...
                    if (cellStyles.TryGetValue(i, out var newCellStyle))
                    {
