...
VALUES('PLANCOTGER',1,'Plantilla de cotización para gerencia','pminetti@ahsecoperu.pe','','PENDIENTE ATENCION - VENTA - N° SOLICITUD {NRO_SOL}',
...
<p>Por favor ingrese al sistema para completar los datos. Ingrese al siguiente link: <a href="{URL}"><span data-olk-copy-source="MessageBody">{URL}</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);
...
<p>Por favor ingrese al sistema para continuar con el flujo de venta. Ingrese al siguiente link: <a href="{URL}"><span data-olk-copy-source="MessageBody">{URL}</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);
...
<p>Ingrese al siguiente link para más información: <a href="{URL}"><span data-olk-copy-source="MessageBody">{URL}</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);
...
<p>Por favor ingrese al sistema para continuar con el flujo de instalación. Ingrese al siguiente link: <a href="{URL}"><span data-olk-copy-source="MessageBody">{URL}</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);
...
<p>Por favor ingrese al sistema para continuar con el flujo de la venta. Ingrese al siguiente link: <a href="{URL}"><span data-olk-copy-source="MessageBody">{URL}</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);
...
<p>{TABLA_DETALLE}</p>
<p>Por favor ingrese al sistema para visualizar la informaci&oacute;n a m&aacute;s detalle. Ingrese al siguiente link: <a href="{URL}"><span data-olk-copy-source="MessageBody">{URL}</span></a>&nbsp;.</p>','SYSTEM',GETDATE(),NULL,NULL);
