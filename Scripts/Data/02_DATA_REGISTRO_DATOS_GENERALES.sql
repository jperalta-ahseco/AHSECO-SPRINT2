...
--DECLARE @ID INT 
INSERT INTO  [TBM_DATOS_GENERALES] VALUES ('DOCXINSTA','DXI','Documentos por Instalación',1,'system',GETDATE())
SELECT @ID=CAST(SCOPE_IDENTITY() AS INT)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0001','DOCXINSTA','Acta',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0002','DOCXINSTA','Programa de Mantenimiento Preventivo',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0003','DOCXINSTA','Procedimiento de Mantenimiento Preventivo',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0004','DOCXINSTA','Protocolo de Pruebas',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0005','DOCXINSTA','Resultado de Protocolo',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0006','DOCXINSTA','Ficha Técnica',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0007','DOCXINSTA','Certificado de Garantía (AHSECO)',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0008','DOCXINSTA','Certificado de Garantía (PROVEEDOR)',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0009','DOCXINSTA','Certificado de Año de Fabricación',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0010','DOCXINSTA','Temática (Horas) Usuario',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0011','DOCXINSTA','Temática (Horas) Usuario',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0012','DOCXINSTA','Constancia de Capacitación Usuario',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
INSERT INTO [TBD_DATOS_GENERALES] VALUES (@ID,'DXI0013','DOCXINSTA','Constancia de Capacitación Técnico',NULL,NULL,NULL,NULL,NULL,NULL,1,'system',GETDATE(),1,1)
