...
VALUES('PLANCOTGER',1,'Plantilla de cotización para gerencia','','','PENDIENTE ATENCION - VENTA - N° SOLICITUD {NRO_SOL}',
			   '<p>Sr. Pedro Minetti,</p>
<p>Usted tiene pendiente de atenci&oacute;n la cotizaci&oacute;n de la solicitud N&deg; {NRO_SOL} para la empresa {NOM_EMPRESA} solicitado por {NOMBRE_VENDEDOR}.</p>
<p>Por favor ingrese al sistema para completar los datos. Ingrese al siguiente link: <a href="{URL}BandejaVentas"><span data-olk-copy-source="MessageBody">{URL}BandejaVentas</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);

INSERT INTO TBM_PLANTILLAS
VALUES('PLANCOTLOG',1,'Plantilla de cotización para logistica','','','PENDIENTE PARA COSTOS - N° SOLICITUD {NRO_SOL}',
			   '<p>Estimado(a),</p>
...
INSERT INTO TBM_PLANTILLAS
VALUES('PLANCOTCOS',1,'Plantilla de cotización para costos','','','PENDIENTE PARA COSTOS - N° SOLICITUD {NRO_SOL}',
			   '<p>Estimado(a),</p>
...
INSERT INTO TBM_PLANTILLAS
VALUES('PLANCOTSTC',1,'Plantilla de cotización para servicio tecnico','','','PENDIENTE PARA COSTOS - N° SOLICITUD {NRO_SOL}',
...
<p>Por favor ingrese al sistema para continuar con el flujo de venta. Ingrese al siguiente link: <a href="{URL}BandejaVentas"><span data-olk-copy-source="MessageBody">{URL}BandejaVentas</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);

INSERT INTO TBM_PLANTILLAS
VALUES('PENAPDSCTO',1,'Plantilla de Descuento Pendiente','','','ATENCION DE DESCUENTO - N° SOLICITUD {NRO_SOL}',
			   '<p>Sr. Pedro Minetti,</p>
...
INSERT INTO TBM_PLANTILLAS
VALUES('PLANINSTEC',3,'Plantilla de instalación técnica para vendedor','','','FINALIZACIÓN DE INSTALACIÓN DE EQUIPOS - N° SOLICITUD {NRO_SOL}',
			   '<p>Estimado(a)s,</p>
...
<p>Ingrese al siguiente link para más información: <a href="{URL}BandejaVentas"><span data-olk-copy-source="MessageBody">{URL}BandejaVentas</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);

-- para despacho:

INSERT INTO TBM_PLANTILLAS
VALUES('PLANGUIAPE',1,'Plantilla de Envio de Guia de Pedidos','','','GUIA DE PEDIDOS - N° SOLICITUD {NRO_SOL}',
...
INSERT INTO TBM_PLANTILLAS
VALUES('PLANSTECV',1,'Plantilla de Envio de Servicio Tecnico','','','ATENCION DE SERVICIO TECNICO - N° SOLICITUD {NRO_SOL}',
			   '<p>Estimado(a) {NOM_COORDINADOR},</p>
<p>Se acordó la aprobación de la cotizacion de la solicitud N°{NRO_SOL} y se generó el despacho con {TIPO_PROCESO} para el cliente {CLIENTE}.</p>
<p>Su apoyo con la atención de la programación de la instalación.</p>
<p>Por favor ingrese al sistema para continuar con el flujo de venta. Ingrese al siguiente link: <a href="{URL}BandejaInstalacionTecnica"><span data-olk-copy-source="MessageBody">{URL}BandejaInstalacionTecnica</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);

INSERT INTO TBM_PLANTILLAS
VALUES('PLANGUIABO',1,'Plantilla de Envio de Guia de BO','','','GUIA DE BO - N° SOLICITUD {NRO_SOL}',
...
INSERT INTO TBM_PLANTILLAS
VALUES('PLANAPRIMP',1,'Plantilla de Envio de Aprobacion a Importar','','','APROBACIÓN DE IMPORTACIÓN - N° SOLICITUD {NRO_SOL}',
...
INSERT INTO TBM_PLANTILLAS
VALUES('PLANFACTUR',1,'Plantilla de Envio de Facturacion','','','ATENCIÓN DE FACTURACIÓN - N° SOLICITUD {NRO_SOL}',
...
INSERT INTO TBM_PLANTILLAS
VALUES('PLANSSERSS',1,'Plantilla Series Serv Tecnico Sin Stock','','','SERIES COMPLETAS SIN STOCK - N° SOLICITUD {NRO_SOL}',
...
<p>Por favor ingrese al sistema para continuar con el flujo de instalación. Ingrese al siguiente link: <a href="{URL}BandejaInstalacionTecnica"><span data-olk-copy-source="MessageBody">{URL}BandejaInstalacionTecnica</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);

INSERT INTO TBM_PLANTILLAS
VALUES('PLANSSERCS',1,'Plantilla Series Serv Tecnico Con Stock','','','SERIES COMPLETAS CON STOCK - N° SOLICITUD {NRO_SOL}',
			   '<p>Estimada Área de Servicio Técnico</p>
...
<p>Por favor ingrese al sistema para continuar con el flujo de la venta. Ingrese al siguiente link: <a href="{URL}BandejaVentas"><span data-olk-copy-source="MessageBody">{URL}BandejaVentas</span></a> .</p>','SYSTEM',GETDATE(),NULL,NULL);
...
<p>{TABLA_DETALLE}</p>
<p>Por favor ingrese al sistema para visualizar la informaci&oacute;n a m&aacute;s detalle. Ingrese al siguiente link: <a href="{URL}BandejaGarantia"><span data-olk-copy-source="MessageBody">{URL}BandejaGarantia</span></a>&nbsp;.</p>','SYSTEM',GETDATE(),NULL,NULL);

--Mantenimiento Preventivo
INSERT INTO TBM_PLANTILLAS
VALUES('PLANPREV',6,'Plantilla de Envío de Guía Manuscrita','','','MANTENIMIENTO PREVENTIVO',
			   '<p>Estimado Sr. {NOM_GERENTE},</p>
...
<p>Por favor ingrese al sistema para visualizar la informaci&oacute;n a m&aacute;s detalle. Ingrese al siguiente link: <a href="{URL}BandejaVentas"><span data-olk-copy-source="MessageBody">{URL}BandejaVentas</span></a>&nbsp;.</p>','SYSTEM',GETDATE(),NULL,NULL);

--ALERTA DE PREVENTIVOS:
INSERT INTO TBM_PLANTILLAS
VALUES('PLANMANT',6,'Plantilla de Mantenimientos Preventivos proximos a vencer','','','MANT. PREVENTIVOS PROXIMOS A REALIZAR',
...
<p>{TABLA_DETALLE}</p>
<p>Por favor ingrese al sistema para visualizar la informaci&oacute;n a m&aacute;s detalle. Ingrese al siguiente link: <a href="{URL}BandejaPreventivo"><span data-olk-copy-source="MessageBody">{URL}BandejaPreventivo</span></a>&nbsp;.</p>','SYSTEM',GETDATE(),NULL,NULL);
