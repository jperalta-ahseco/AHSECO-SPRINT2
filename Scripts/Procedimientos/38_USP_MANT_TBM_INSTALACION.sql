...
BEGIN
	...
	IF (@IsTipoProceso = 'I')
		BEGIN
			INSERT INTO TBM_INSTALACION(ID_WORKFLOW,ID_SOLICITUD,RUCEMPRESA,NOMEMPRESA,UBICACION,NOMBRECONTACTO,TELEFONOCONTACTO,EMAILCONTACTO,CARGOCONTACTO,ESTABLECIMIENTO,
										TIPOVENTA,ORDENCOMPRA,NUMPROCESO,TIPOPROCESO,VENDEDOR,CODEMPRESA,FECHAMAX,DESTINO,ESTADO,USR_REG,FEC_REG,GARANTIA)
			VALUES (@ID_WORKFLOW, @ID_SOLICITUD, @RUCEMPRESA,@NOMEMPRESA,@UBICACION,@NOMBRECONTACTO,@TELEFONOCONTACTO,@EMAILCONTACTO,@CARGOCONTACTO,@ESTABLECIMIENTO
					,@TIPOVENTA,@ORDENCOMPRA,@NUMPROCESO,@TIPOPROCESO,@VENDEDOR,@CODEMPRESA,@FECHAMAX ,@DESTINO,@ESTADO,@UsrEjecuta, GETDATE(),@GARANTIA)
