	...
	IF (@IsTipoProceso = 'I')
		BEGIN
			INSERT INTO TBM_INSTALACION(ID_WORKFLOW,ID_SOLICITUD,RUCEMPRESA,NOMEMPRESA,UBICACION,NOMBRECONTACTO,TELEFONOCONTACTO,CARGOCONTACTO,ESTABLECIMIENTO,
										TIPOVENTA,ORDENCOMPRA,NUMPROCESO,CONTRATO,VENDEDOR,CODEMPRESA,FECHAMAX,DESTINO,ESTADO,USR_REG,FEC_REG)
			VALUES (@ID_WORKFLOW, @ID_SOLICITUD, @RUCEMPRESA,@NOMEMPRESA,@UBICACION,@NOMBRECONTACTO,@TELEFONOCONTACTO,@CARGOCONTACTO,@ESTABLECIMIENTO,@TIPOVENTA,@ORDENCOMPRA,@NUMPROCESO,@CONTRATO,@VENDEDOR,@CODEMPRESA,@FECHAMAX,@DESTINO,@ESTADO,@UsrEjecuta, GETDATE())
