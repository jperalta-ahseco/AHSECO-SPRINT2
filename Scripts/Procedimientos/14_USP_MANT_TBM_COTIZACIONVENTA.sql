...
BEGIN
	...
	BEGIN
		...
		VALUES
		(@isID_SOLICITUD,@isFEC_COTIZACION,@isIDCONTACTO,@isNOMBRECONTACTO,@isAREACONTACTO,@isTELEFONOCONTACTO,@isEMAILCONTACTO,@isPLAZOENTREGA,
	...
	BEGIN
		...
		IF ISNULL(@isPORCDSCTO,0) <> ISNULL(@isPORCDSCTO_ACTUAL,0) BEGIN
