...
BEGIN
	...
	IF (@pTipoProceso IN ('I','U','D')) BEGIN
		...
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0001';
		...
		--
		SELECT @TOTALCANTCOSTO = SUM(ISNULL(CANTCOSTO,0)) FROM [dbo].[TBD_COTIZACIONCOSTOS]
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0002';
		...
		--
		SELECT @TOTALCANTCOSTO = SUM(ISNULL(CANTCOSTO,0)) FROM [dbo].[TBD_COTIZACIONCOSTOS]
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0003';
		...
		--
		SELECT @TOTALCANTCOSTO = SUM(ISNULL(CANTCOSTO,0)) FROM [dbo].[TBD_COTIZACIONCOSTOS]
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0004';
		...
		--
		SELECT @TOTALCANTCOSTO = SUM(ISNULL(CANTCOSTO,0)) FROM [dbo].[TBD_COTIZACIONCOSTOS]
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0005';
		...
		--
		SELECT @TOTALCANTCOSTO = SUM(ISNULL(CANTCOSTO,0)) FROM [dbo].[TBD_COTIZACIONCOSTOS]
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0006';
		...
		--
		SELECT @TOTALCANTCOSTO = SUM(ISNULL(CANTCOSTO,0)) FROM [dbo].[TBD_COTIZACIONCOSTOS]
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0007';
		...
		--
		SELECT @TOTALCANTCOSTO = SUM(ISNULL(CANTCOSTO,0)) FROM [dbo].[TBD_COTIZACIONCOSTOS]
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0008';
		...
		--
		SELECT @TOTALCANTCOSTO = SUM(ISNULL(CANTCOSTO,0)) FROM [dbo].[TBD_COTIZACIONCOSTOS]
		WHERE ID_COTDETALLE = @pId_CotDetalle AND CODCOSTO = 'CXCD0009';
		...
		IF ISNULL(@INDINFOVIDEO,'') = 'S' AND ISNULL(@FLAG_VIDEOS,0) < 2 BEGIN
			SET @INDCOSTEADO = 'N'
		END
		IF ISNULL(@INDINFOMANUAL,'') = 'S' AND ISNULL(@FLAG_MANUALES,0) < 2 BEGIN
			SET @INDCOSTEADO = 'N'
		END
		IF ISNULL(@INDINSTALACION,'') = 'S' AND ISNULL(@FLAG_INSTALACION,0) < 2 BEGIN
			SET @INDCOSTEADO = 'N'
		END
		IF ISNULL(@INDCAPACITACION,'') = 'S' AND ISNULL(@FLAG_CAPACITACION,0) < 2 BEGIN
			SET @INDCOSTEADO = 'N'
		END
		IF ISNULL(@INDGARANADIC,'') = 'S' AND ISNULL(@FLAG_GARANTADIC,0) < 2 BEGIN
			SET @INDCOSTEADO = 'N'
		END
		IF ISNULL(@INDMANTPREVENT,'') = 'S' AND ISNULL(@FLAG_MANTPREV,0) < 2 BEGIN
			SET @INDCOSTEADO = 'N'
		END
		IF ISNULL(@INDCALIB,'') = 'S' AND ISNULL(@FLAG_CALIB,0) < 2 BEGIN
			SET @INDCOSTEADO = 'N'
		END
