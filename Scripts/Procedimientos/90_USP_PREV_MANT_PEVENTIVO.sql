...
(
	...
	,@IsVAL_OTM				  VARCHAR(50)
	,@IsFECGUIA				  DATETIME
	,@IsVAL_GUIA			  VARCHAR(50)
...
BEGIN
	...
	IF (@IsTipoEjecucion = 'I')
		BEGIN
			INSERT INTO [dbo].[TBD_MANT_PREV](ID_MANT,ID_WORKFLOW,FECHAMANTENIMIENTO,MONTOPRESTACCE,INDPRESTACION,VAL_OTM,INDREPUESTO,NUMFACTURA,FECHAFACTURA,ESTADO,USR_REG,FEC_REG)
			VALUES (@IsID_MANT,@IsID_WORKFLOW,@IsFECHAMANTENIMIENTO,@IsMONTOPRESTACCE,@IsINDPRESTACION,@IsVAL_OTM,@IsINDREPUESTO,@IsNUMFACTURA,@IsFECHAFACTURA,@IsESTADO,@IsUsrEjecuta,GETDATE())
