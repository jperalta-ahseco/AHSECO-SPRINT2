...
/****Obtenemos el número de preventivos *********************************************************************/
	...
	WHERE DESPACHO.NUMSERIE = CAST(@IsNumSerie AS VARCHAR(100)) AND ISNULL(COTDET.ELIMINADO,'N') != 'S'
	...
	WHERE COTIZ.ID_SOLICITUD = @ID_SOLICITUD AND NUMSERIE = CAST(@IsNumSerie AS VARCHAR(100)) AND ISNULL(COTDET.ELIMINADO,'N') != 'S'
