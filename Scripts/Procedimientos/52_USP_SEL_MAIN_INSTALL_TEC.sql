...
BEGIN
	--Instalacion
	EXEC [dbo].[USP_SEL_INSTALL_TEC] @IsRequerimiento = @isNumReq, @isFecIni = '', @isFecFin = '' , @IsEstado='' ,@IsDestino='' ,@IsVendedor='' ,@IsRuc='' ,@IsCodEmpresa='' ,@IsTipVenta='0' ,@IsNumProceso='' ,@IsTipoProcesoVenta='' ,@IsNumOrdenCompra='' ,@IsNumFianza='', @isModelo = '', @IsNumFianzaApp = '', @IsNumFianzaApa= ''
