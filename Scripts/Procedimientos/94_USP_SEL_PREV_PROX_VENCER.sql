...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	SELECT
		...
		,parcial.SERIE
		,parcial.DESCRIPCION
		,CONVERT(VARCHAR(10),parcial.FECHAINSTALACION,103) FECHAINSTALACION
	...
	LEFT JOIN [dbo].[TBD_DATOS_GENERALES] GARANT WITH(NOLOCK) ON parcial.CODGARANTIA = GARANT.PARAMETRO AND DOMINIO = 'GARANTIAS' AND GARANT.ESTADO = '1'
