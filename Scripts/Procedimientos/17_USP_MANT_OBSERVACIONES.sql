...
CREATE OR ALTER PROCEDURE [dbo].[USP_MANT_OBSERVACIONES] 
(
	...
	IF (@IsTipoProceso = 'I')
		BEGIN
			INSERT INTO TBM_OBSERVACIONES(ID_WORKFLOW,ESTADO_INSTANCIA,OBSERVACION,NOMBRE_USUARIO,PERFIL_USUARIO,CODREF,USR_REG,FEC_REG)
					VALUES(@isID_WORKFLOW,@isESTADO_INSTANCIA,@isOBSERVACION,@isNOMBRE_USUARIO,@isPERFIL_USUARIO,@isCODREF,@isUSR_REG,GETDATE())
