...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	SELECT
		...
		,CAST(ISNULL(GAR.COD_VALOR2,0) AS INT)		AS NMESGARANADIC
	...
	LEFT JOIN [dbo].[TBD_DATOS_GENERALES] AS GAR WITH(NOLOCK) ON GAR.DOMINIO='GARANTIAS' AND COTDET_DESP.CODGARANADIC=GAR.PARAMETRO AND GAR.ESTADO=1
