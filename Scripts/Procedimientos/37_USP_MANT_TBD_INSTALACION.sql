...
BEGIN
	...
	IF (@IsTipoProceso = 'I')
		BEGIN
			INSERT INTO TBD_INSTALACION(ID_DETALLECOTIZ,ID_DESPACHO_DIST,NUMREQ,CODIGOPRODUCTO,DESCRIPCION,CANTIDAD,MARCA,SERIE,NUMFIANZA,CANTIDADMP,PERIODICIDAD,INDLLAVEMANO,
										CODUBIGEODEST,DIRECCION,NROPISO,DIMENSIONES,FECLIMINSTA,INDFIANZA,MONTOPPRINC,MONTOPACCE,USR_REG,FEC_REG)
			VALUES (@IsID_DETALLECOTIZ,@IsID_DESPACHO_DIST,@IsNUMREQ,@IsCODIGOPRODUCTO,@IsDESCRIPCION,@IsCANTIDAD,@IsMARCA,@IsSERIE,@IsNUMFIANZA,@IsCANTIDADMP,@IsPERIODICIDAD,@IsINDLLAVEMANO,
					@IsCODUBIGEODEST,@IsDIRECCION,@IsNROPISO,@IsDIMENSIONES,@IsFECLIMINSTA,@IsINDFIANZA,@IsMONTOPPRINC,@IsMONTOPACCE,@UsrEjecuta,GETDATE())
			IF @@ROWCOUNT = 0
			BEGIN
				SET @COD = 0;
