...
BEGIN
	...
	SET @sql = '
					SELECT
						...
						,RECLAMO.EMAILCONTACTO					AS EMAILCONTACTO
						,RECLAMO.ORDENCOMPRA
						,RECLAMO.NUMPROCESO
						,RECLAMO.TIPOPROCESO
						,RECLAMO.CONTRATO
					...
					LEFT JOIN [dbo].[TBD_DATOS_GENERALES] datos WITH(NOLOCK) ON datos.PARAMETRO = RECLAMO.CODEMPRESA
