...
CREATE PROCEDURE [dbo].[USP_MANT_SERVICIOS] 
/*=======================================================================================================
...
BEGIN
	...
	IF (@IsTipoProceso = 'I')
		BEGIN
			INSERT INTO TBM_SERVICIOS(TIPO_SERVICIO,DESCRIPCIONEQUIPO,CODEQUIPO,NOMBREMARCA,NOMBREMODELO,PRECIOPREVENTIVO,PRECIOCAPACITACION,PRECIOSOFTWARE,INSTRUMENTOS,TOOLCOMUN,TOOLESPECIAL,ESTADO,USR_REG,FEC_REG)
			VALUES (@IsTIPOSERVICIO,@IsDESCRIPCIONEQUIPO,@IsCODEQUIPO,@IsNOMBREMARCA,@IsNOMBREMODELO,@IsPRECIOPREVENTIVO,@IsPRECIOCAPACITACION,@IsPRECIOSOFTWARE,@IsINSTRUMENTOS,@IsTOOLCOMUN,@IsTOOLESPECIAL,@IsESTADO,@IsUsrEjecuta, GETDATE())
