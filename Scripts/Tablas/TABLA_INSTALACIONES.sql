...
DROP TABLE [TBM_INSTAL_CONTACTO]
*/
...
CREATE TABLE [TBD_INSTALACION] (
	...
	ID_DETALLECOTIZ BIGINT NOT NULL,
...
CREATE TABLE [TBM_INSTAL_CONTACTO]
(
	...
	,USR_MOD			VARCHAR(50) NULL
	,FEC_MOD			DATETIME NULL
	 CONSTRAINT [PK_TBM_INSTAL_CONTACTO] PRIMARY KEY CLUSTERED 
(
	[ID_ASIG] ASC
)
) ON [PRIMARY]
