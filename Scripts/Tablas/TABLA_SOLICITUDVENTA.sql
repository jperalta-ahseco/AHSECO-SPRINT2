...
ALTER TABLE TBD_COTDET_ACTIVIDAD DROP CONSTRAINT FK_TBD_COTIZACIONVENTA3
GO
DROP TABLE TBD_COTDET_ACTIVIDAD
GO

ALTER TABLE TBD_DESPACHO_DIST DROP CONSTRAINT FK_TBD_COTIZACIONVENTA2
GO
...
DROP TABLE TBD_TECNICODESPACHO
GO
...
(
	...
	[DIRECCION][VARCHAR](150) NULL,
	[RUTA_DOCUMENTO][VARCHAR](350) NULL,
...
CREATE TABLE [dbo].[TBD_COTDET_ACTIVIDAD](
	[ID] [bigint] IDENTITY(1,1) NOT NULL,
	[ID_COTDETALLE] [bigint] NOT NULL,
...
ALTER TABLE [dbo].[TBD_COTDET_ACTIVIDAD]  WITH CHECK ADD  CONSTRAINT [FK_TBD_COTIZACIONVENTA3] FOREIGN KEY([ID_COTDETALLE])
REFERENCES [dbo].[TBD_COTIZACIONVENTA] ([ID])
GO

ALTER TABLE [dbo].[TBD_COTDET_ACTIVIDAD] CHECK CONSTRAINT [FK_TBD_COTIZACIONVENTA3]
GO
