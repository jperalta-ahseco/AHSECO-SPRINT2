...
ALTER TABLE TBD_COTIZACIONCOSTOS DROP CONSTRAINT FK_TBM_COTIZACIONVENTA_2
GO
...
CREATE TABLE [dbo].[TBD_COTIZACIONVENTA](
	...
	[DESCRIPADIC] [varchar](1000) NOT NULL,
	[STOCK] [int] NOT NULL,
...
CREATE TABLE [dbo].[TBM_COTDET_DESPACHO](
	...
	[CANTCALIB] [int] NULL,
	[MONTOCALIB] [decimal](18, 9) NULL,
	[OBSXCLIENTE] [varchar](2000) NULL,
...
ALTER TABLE TBD_COTIZACIONCOSTOS ADD CONSTRAINT FK_TBM_COTIZACIONVENTA_2
